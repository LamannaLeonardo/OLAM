...
:precondition (and
 (at-curb-num ?param_1 ?param_2) (car-clear ?param_1) (curb-clear ?param_3) (at-curb ?param_1)
)
...
:precondition (and
 (at-curb ?param_3) (at-curb-num ?param_1 ?param_2) (car-clear ?param_1) (car-clear ?param_3) (at-curb ?param_1)
)
...
:precondition (and
 (behind-car ?param_1 ?param_2) (curb-clear ?param_3) (at-curb ?param_2) (car-clear ?param_1)
)
...
:precondition (and
 (at-curb ?param_3) (behind-car ?param_1 ?param_2) (car-clear ?param_3) (at-curb ?param_2) (car-clear ?param_1)
)
