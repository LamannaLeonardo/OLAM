...
:precondition (and
					(at-curb ?param_1) (at-curb-num ?param_1 ?param_2) (car-clear ?param_1) (curb-clear ?param_3)
)
...
:precondition (and
					(at-curb ?param_1) (at-curb ?param_3) (at-curb-num ?param_1 ?param_2) (at-curb-num ?param_3 ?param_2) (car-clear ?param_1) (car-clear ?param_3)
)
