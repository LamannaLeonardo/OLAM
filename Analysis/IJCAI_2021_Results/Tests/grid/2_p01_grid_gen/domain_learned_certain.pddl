...
:precondition (and
		(at-robot ?param_1) (holding ?param_3) (key-shape ?param_3 ?param_4) (lock-shape ?param_2 ?param_4) (locked ?param_2)
)
...
:precondition (and
		(arm-empty) (at ?param_2 ?param_1) (at-robot ?param_1)
)
...
:precondition (and
		(at ?param_2 ?param_1) (at-robot ?param_1) (holding ?param_3)
)
...
:parameters (?param_1 - place ?param_2 - key)  
:precondition (and
		(at-robot ?param_1) (holding ?param_2)
)
