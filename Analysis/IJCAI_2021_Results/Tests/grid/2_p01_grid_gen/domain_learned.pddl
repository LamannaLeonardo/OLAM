...
:precondition (and
 (at-robot ?param_1) (holding ?param_3) (locked ?param_2) (lock-shape ?param_2 ?param_4) (open ?param_1) (conn ?param_2 ?param_1) (conn ?param_1 ?param_2) (key-shape ?param_3 ?param_4)
)
...
:precondition (and
 (at-robot ?param_1) (open ?param_2) (open ?param_1) (conn ?param_2 ?param_1) (conn ?param_1 ?param_2)
)
...
:precondition (and
 (at ?param_2 ?param_1) (at-robot ?param_1) (arm-empty) (open ?param_1)
)
...
:precondition (and
					(at ?param_2 ?param_1) (at-robot ?param_1) (holding ?param_3) (open ?param_1)
)
:effect (and (at ?param_3 ?param_1) (holding ?param_2) (not (at ?param_2 ?param_1)) (not (holding ?param_3))))
