...
:effect (and (loaded ?param_1 ?param_2 ?param_7) (ready-to-load ?param_1 ?param_3 ?param_4) ))
...
:effect (and  (not (ready-to-load ?param_2 ?param_3 ?param_6)) (not (on-sale ?param_2 ?param_3 ?param_5))))
)
