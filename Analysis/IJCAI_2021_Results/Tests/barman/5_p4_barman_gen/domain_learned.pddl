...
:precondition (and
 (clean ?param_3) (contains ?param_1 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (shaker-empty-level ?param_3 ?param_5) (used ?param_1 ?param_2) (shaker-level ?param_3 ?param_5) (empty ?param_3)
)
...
:precondition (and
 (contains ?param_2 ?param_3) (holding ?param_1 ?param_2) (shaker-empty-level ?param_2 ?param_5) (shaker-level ?param_2 ?param_4) (shaked ?param_2)
)
...
:precondition (and
 (clean ?param_2) (contains ?param_4 ?param_1) (holding ?param_3 ?param_4) (next ?param_6 ?param_5) (shaked ?param_4) (shaker-level ?param_4 ?param_5) (empty ?param_2)
)
