...
:precondition (and
					(clean ?param_1) (dispenses ?param_5 ?param_2) (empty ?param_1) (handempty ?param_4) (holding ?param_3 ?param_1)
)
...
:precondition (and
					(contains ?param_2 ?param_3) (holding ?param_1 ?param_2) (used ?param_2 ?param_3)
)
...
:precondition (and
					(clean ?param_3) (contains ?param_1 ?param_2) (empty ?param_3) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (ontable ?param_3) (shaker-empty-level ?param_3 ?param_5) (shaker-level ?param_3 ?param_5) (used ?param_1 ?param_2)
)
...
:parameters (?param_1 - shot ?param_2 - ingredient ?param_3 - shaker ?param_4 - hand ?param_5 ?param_6 - level) 
:precondition (and
					(contains ?param_1 ?param_2) (contains ?param_3 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (ontable ?param_3) (shaker-level ?param_3 ?param_5) (unshaked ?param_3) (used ?param_1 ?param_2)
)
...
:precondition (and
					(clean ?param_3) (empty ?param_3) (handempty ?param_2) (holding ?param_1 ?param_3)
)
:effect (and  ))
