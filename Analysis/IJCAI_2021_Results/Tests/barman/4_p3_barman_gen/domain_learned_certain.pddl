...
:precondition (and
		(clean ?param_3) (contains ?param_1 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6)
)
...
:parameters (?param_1 - shot ?param_2 - ingredient ?param_3 - shaker ?param_4 - hand ?param_5 ?param_6 - level) 
:precondition (and
		(contains ?param_1 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (shaker-level ?param_3 ?param_5) (unshaked ?param_3)
)
...
:precondition (and
		(contains ?param_2 ?param_3) (holding ?param_1 ?param_2) (shaker-empty-level ?param_2 ?param_5) (shaker-level ?param_2 ?param_4)
)
...
:precondition (and
		(cocktail-part1 ?param_1 ?param_2) (cocktail-part2 ?param_1 ?param_3) (contains ?param_4 ?param_2) (contains ?param_4 ?param_3) (handempty ?param_6) (holding ?param_5 ?param_4)
)
...
:precondition (and
		(clean ?param_2) (contains ?param_4 ?param_1) (holding ?param_3 ?param_4) (next ?param_6 ?param_5) (shaked ?param_4) (shaker-level ?param_4 ?param_5)
)
