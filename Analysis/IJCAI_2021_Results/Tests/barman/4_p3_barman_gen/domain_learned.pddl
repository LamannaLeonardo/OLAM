...
:precondition (and
					(contains ?param_2 ?param_3) (holding ?param_1 ?param_2) (shaked ?param_2) (shaker-empty-level ?param_2 ?param_5) (shaker-level ?param_2 ?param_4)
)
...
:precondition (and
					(clean ?param_2) (contains ?param_4 ?param_1) (empty ?param_2) (holding ?param_3 ?param_4) (next ?param_6 ?param_5) (shaked ?param_4) (shaker-level ?param_4 ?param_5)
)
