...
:precondition (and
 (clean ?param_1) (dispenses ?param_5 ?param_2) (handempty ?param_4) (holding ?param_3 ?param_1) (empty ?param_1)
)
...
:precondition (and
 (contains ?param_1 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (shaker-empty-level ?param_3 ?param_5) (used ?param_1 ?param_2) (shaker-level ?param_3 ?param_5) (empty ?param_3) (clean ?param_3)
)
...
:parameters (?param_1 - shot ?param_2 - ingredient ?param_3 - shaker ?param_4 - hand ?param_5 ?param_6 - level) 
:precondition (and
					(contains ?param_1 ?param_2) (holding ?param_4 ?param_1) (next ?param_5 ?param_6) (shaker-level ?param_3 ?param_5) (unshaked ?param_3) (used ?param_1 ?param_2)
)
:effect (and (shaker-level ?param_3 ?param_6) (empty ?param_1) (contains ?param_3 ?param_2) (not (contains ?param_1 ?param_2)) (not (shaker-level ?param_3 ?param_5))))

 (:action empty-shaker 
:parameters (?param_1 - hand ?param_2 - shaker ?param_3 - cocktail ?param_4 ?param_5 - level) 
:precondition (and
					(contains ?param_2 ?param_3) (holding ?param_1 ?param_2) (next ?param_5 ?param_4) (shaked ?param_2) (shaker-empty-level ?param_2 ?param_5) (shaker-level ?param_2 ?param_4)
)
:effect (and (shaker-level ?param_2 ?param_5) (empty ?param_2) (not (contains ?param_2 ?param_3)) (not (shaked ?param_2)) (not (shaker-level ?param_2 ?param_4))))

 (:action clean-shaker   
:parameters (?param_1 ?param_2 - hand ?param_3 - shaker) 
:precondition (and
					(empty ?param_3) (handempty ?param_2) (holding ?param_1 ?param_3)
)
:effect (and (clean ?param_3) ))

 (:action shake   
:parameters (?param_1 - cocktail ?param_2 ?param_3 - ingredient ?param_4 - shaker ?param_5 ?param_6 - hand) 
:precondition (and
					(cocktail-part1 ?param_1 ?param_2) (cocktail-part2 ?param_1 ?param_3) (contains ?param_4 ?param_2) (contains ?param_4 ?param_3) (handempty ?param_6) (holding ?param_5 ?param_4) (unshaked ?param_4)
)
:effect (and (contains ?param_4 ?param_1) (shaked ?param_4) (not (contains ?param_4 ?param_3)) (not (contains ?param_4 ?param_2)) (not (unshaked ?param_4))))

 (:action pour-shaker-to-shot 
:parameters (?param_1 - beverage ?param_2 - shot ?param_3 - hand ?param_4 - shaker ?param_5 ?param_6 - level) 
:precondition (and
					(clean ?param_2) (contains ?param_4 ?param_1) (empty ?param_2) (holding ?param_3 ?param_4) (next ?param_6 ?param_5) (ontable ?param_2) (shaked ?param_4) (shaker-level ?param_4 ?param_5)
)
:effect (and (shaker-level ?param_4 ?param_6) (contains ?param_2 ?param_1) (not (empty ?param_2)) (not (clean ?param_2)) (not (shaker-level ?param_4 ?param_5))))
)
