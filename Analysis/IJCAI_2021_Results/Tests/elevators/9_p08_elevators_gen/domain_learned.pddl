...
:precondition (and
 (can-hold ?param_2 ?param_5) (lift-at ?param_2 ?param_3) (next ?param_4 ?param_5) (passenger-at ?param_1 ?param_3) (passengers ?param_2 ?param_4) (above ?param_4 ?param_5)
)
...
:parameters (?param_1 - passenger ?param_2 - elevator ?param_3 - count ?param_4 - count ?param_5 - count) 
:precondition (and
 (boarded ?param_1 ?param_2) (lift-at ?param_2 ?param_3) (next ?param_5 ?param_4) (passengers ?param_2 ?param_4) (can-hold ?param_2 ?param_4) (above ?param_5 ?param_4)
)
