...
:parameters (?param_1 - hand ?param_2 ?param_3 - block) 
:precondition (and
					(block-negative ?param_2) (block-positive ?param_3) (clear ?param_3) (hand-positive ?param_1) (holding ?param_1 ?param_2) (solid ?param_3)
)
...
:parameters (?param_1 - hand ?param_2 ?param_3 - block) 
:precondition (and
					(block-negative ?param_3) (block-positive ?param_2) (clear ?param_3) (hand-negative ?param_1) (holding ?param_1 ?param_2) (on-table ?param_3) (solid ?param_3)
)
:effect (and (on ?param_2 ?param_3) (clear ?param_2) (empty ?param_1) (not (holding ?param_1 ?param_2)) (not (solid ?param_2)) (not (clear ?param_3))))
